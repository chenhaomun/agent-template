...
Focus: app behavior against BA requirements, acceptance criteria, user flows, production-readiness risk, and success/loading/empty/error/permission/regression scenarios — via static checks and functional/manual app scenarios.
